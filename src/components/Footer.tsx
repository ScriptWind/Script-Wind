...
import { Facebook, Instagram, Linkedin, Twitter, Youtube, Mail, Phone, MapPin, ArrowUp, Send, CheckCircle } from "lucide-react";
...
const socialLinks = [{
  ...
  name: "TikTok",
  icon: (props: any) => <svg {...props} viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43V7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.43z" /></svg>,
  url: "#"
}, {
  name: "Threads",
  icon: (props: any) => <svg {...props} viewBox="0 0 24 24" fill="currentColor"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.5 12.01 1.5 4.718 5.486.734 12.014.734c6.524 0 10.486 3.984 10.486 11.276 0 3.576-.851 6.43-2.496 8.481-1.85 2.304-4.603 3.485-8.184 3.509z" /></svg>,
  url: "#"
}, {
  name: "Twitter/X",
  icon: Twitter,
