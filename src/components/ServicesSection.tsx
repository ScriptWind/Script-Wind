  ...
  return <section className="py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {services.map((service, index) => <Card key={service.title} className={`group hover-lift animate-fade-in`} style={{
          animationDelay: `${index * 0.2}s`
        }}>
              <CardHeader className="relative">
                {/* Service Image */}
                <div className="w-full h-48 rounded-lg overflow-hidden mb-6">
                  <img src={service.image} alt={service.title} className="w-full h-full object-cover transition-smooth group-hover:scale-110" />
                </div>
